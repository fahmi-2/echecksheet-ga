    ...
    useEffect(() => {
        ...
        try {
        const storageKey = `${mainType}-${subType}-${checkType}-${id}-${shift}-${date}`
    ...
    }, [id, shift, date, mainType, subType, checkType])
    ...
    const handlePelaporanSubmit = (e: React.FormEvent) => {
        ...
        const pelaporan: PelaporanData = {
            ...
            status: "open", // Status awal adalah "open"
            ngItemsDetail: ngItems,
        }
        ...
        // Save notification dengan pelaporanId untuk navigasi
        const notifications = JSON.parse(localStorage.getItem("notifications") || "[]")
        notifications.push({
            id: `notif-${Date.now()}`,
            pelaporanId: pelaporan.id, // 🔹 Tambah pelaporanId
            type: "ng_report",
