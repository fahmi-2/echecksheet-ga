...
export default function FinalAssyInspectorStatusPage() {
  ...
  const storageKey = "finalAssyInspectorDailyCheckResults"
  ...
  const renderStatusCell = (date: number, checkpoint: CheckPoint) => {
    ...
    if (date === today) {
      ...
      return (
        <Link
          href={`/e-checksheet?id=${checkpoint.id}&shift=${checkpoint.shift}&date=${dateStr}&mainType=final-assy&subType=inspector`}
    ...
    <div className="app-page">
      ...
      <div className="page-content">
        <div className="header">
          <h1>Daily Check Inspector Final Assy</h1>
