...
const HYDRANT_LIST: HydrantItem[] = [
  ...
  { no: 13, lokasi: "OFFICE WHS", zona: "UTARA", jenisHydrant: "H--YDRANT INDOOR" },
...
export function GaInspeksiHydrantContent() {
  ...
  useEffect(() => {
    ...
    const onScanError = (error: string | Error) => {
      // Silent error handling — jangan ganggu scanning berulang
      console.warn("QR scan error:", error);
    };

    // ✅ Kompatibel dengan qr-scanner@1.4.2
