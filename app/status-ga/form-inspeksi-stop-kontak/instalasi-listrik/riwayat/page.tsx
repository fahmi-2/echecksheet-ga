...
export default function RiwayatInstalasiListrik() {
  ...
  if (isLoading) return <div className="loading">Loading riwayat...</div>;
                ...
                <div key={entry.id} className="history-card">
                  ...
                  >
                    <div className="header-info">
                      <div>
                        <h3>{entry.area}</h3>
                        {/* ✅ Tanggal inspeksi (tanpa waktu) */}
                        <p>{formatDateOnly(entry.tanggal)}</p>
                      </div>
                  ...
                  {isExpanded && (
                    <div className="card-body">
                      <div className="meta-info">
                        ...
                        <div>
                          <strong>Tanggal Inspeksi:</strong> {formatDateOnly(entry.tanggal)}
                        </div>
                        <div>
                          <strong>Waktu Input:</strong> {formatDateTime(entry.createdAt)}
                        </div>
                      </div>
