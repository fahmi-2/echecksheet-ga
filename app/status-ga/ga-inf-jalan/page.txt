                  ...
                  return (
                    <tr key={area.no} style={{ transition: "background-color 0.2s ease" }}>
                      ...
                      <span style={{
                        ...
                        fontSize: "13px",
                        fontWeight: "600",
                        whiteSpace: "nowrap",       // ⬅️ tetap satu baris
                        overflow: "hidden",         // ⬅️ sembunyikan teks berlebih
                        textOverflow: "ellipsis",   // ⬅️ tampilkan ...
                        display: "inline-block",
                        maxWidth: "140px"           // ⬅️ wajib agar ellipsis bekerja
                      }}>
                        {area.kategori}
                      </span>
                      </td>
