// app/exit-lamp-pintu-darurat/riwayat/exit-lamp/page.tsx
"use client"
...
export default function RiwayatExitLamp() {
  ...
  const [filteredRecords, setFilteredRecords] = useState<ExitLampRecord[]>([])
  ...
  useEffect(() => {
    const loadRecords = () => {
      try {
        ...
        console.error("Gagal memuat riwayat Exit Lamp:", e)
      } finally {
        setLoading(false)
      }
    }
    ...
    <div className="app-page">
      ...
      <div className="page-content">
        <div className="header">
          <h1>💡 Riwayat Exit Lamp & Emergency Lamp</h1>
