...
export default function PreAssyGLStatusPage() {
  ...
  const renderStatusCell = (date: number, checkpoint: CheckPoint) => {
    ...
    if (date === today) {
      ...
      return (
        <Link
          href={`/e-checksheet?id=${checkpoint.id}&shift=${checkpoint.shift}&date=${dateStr}&mainType=pre-assy&subType=group-leader`}
    ...
    <div className="app-page">
      ...
      <div className="page-content">
        <div className="header">
          <h1>Daily Check Group Leader Pre Assy</h1>
        ...
        {/* 🔹 Button CC & Stripping — redirect ke halaman terpisah */}
        <div className="button-group">
          ...
          <button
            className="btn btn-cc-stripping"
            onClick={() => router.push("/status-pre-assy-cc-stripping")}
          >
            🔧 CC & Stripping
          </button>
        </div>
