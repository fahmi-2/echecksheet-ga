...
export default function EChecksheetTgListrikPage() {
  ...
  const areaName = searchParams?.get("areaName") || "Tangga Listrik"
  const lokasi = searchParams?.get("lokasi") || "Lokasi"

  // Data item berdasarkan file Excel cs-tangga-listrik.xlsx
  ...
  // Generate 2 jadwal inspeksi per bulan: minggu ke-2 dan ke-4
                  ...
                  <React.Fragment key={groupName}>
                    {groupItems.map((item, index) => (
                      <tr key={item.key}>
                        ...
                        alt={item.itemCek}
                        onError={(e) => {
                            // Gunakan data URI SVG placeholder tanpa require file eksternal
